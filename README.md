...
Reliar delivers **at-least-once**. A message enqueued in your database transaction is published at
...
- **A real broker:** `examples/nats-pub-sub` — the outbox draining into NATS `JetStream`, an
  enqueued and a directly-published message side by side, and a subscriber decoding what arrives.
  Walkthrough: `docs/guides/nats.md`; the two call sites: `docs/guides/outbox-enqueue-and-publish.md`.
