...
revised by appending a dated amendment to its own record; a **shipped** one is changed only by a
successor ADR that supersedes it — the rule and the ship test are in `docs/decisions/README.md`.
